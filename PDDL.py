...
class Action:
    def __init__(self, name, parameters, positive_preconditions, negative_preconditions, add_effects, del_effects, extensions):
        self.name = name
    ...
    def __repr__(self):
        ...
        return '{}({})| + {} | - {}'.format(self.name, ', '.join(params), self.positive_preconditions, self.negative_preconditions)
